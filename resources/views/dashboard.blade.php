    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="bg-gray-900 border border-gray-800 p-5 rounded-2xl flex flex-col justify-between hover:border-gray-700 transition duration-200 shadow-xl">
            ...
            <a href="{{ route('cotizaciones.index') }}"
               class="block text-center bg-yellow-400 hover:bg-yellow-500 text-gray-950 text-[11px] font-bold py-2.5 rounded-xl transition shadow-lg active:scale-95 uppercase tracking-wider">
        ...
        <div class="bg-gray-900 border border-gray-800 p-5 rounded-2xl flex flex-col justify-between hover:border-gray-700 transition duration-200 shadow-xl">
            ...
            <a href="{{ route('testimonios.index') }}"
               class="block text-center bg-gray-950 hover:bg-gray-800 text-gray-400 hover:text-white border border-gray-800 hover:border-gray-700 text-[11px] font-bold py-2.5 rounded-xl transition active:scale-95 uppercase tracking-wider">
