    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-24">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="/proyectos/crear" class="text-gray-300 hover:text-yellow-400 transition">Proyectos</a>
                <a href="{{ route('proyectos.publico') }}" 
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4">
            ...
            <a href="/proyectos/crear" class="block py-3 text-gray-300 hover:text-yellow-400">Proyectos</a>
